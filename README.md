...
| [oauth-app](examples/oauth-app/)                       | A third-party web app with GEA user OAuth, backend token rotation, file attachments, Agent chat and generated Artifact downloads over HTTP.    |
