...
- Real-model peer delivery after the host fix and the complete hosted matrix remain pending certificate renewal plus deployment of the server fix and use of the matching CLI. Do not describe this upgrade as fully hosted-verified. Earlier records below concern older SDK/host versions.
