...
Use Node 24.16.0 and pnpm 12.1.0. The example pins published packages: Agent SDK `0.1.260918-alpha.0` and CLI `0.1.260917-alpha.0`. The SDK brings the matching Contract version. No local GEA checkout or SDK tarballs are required.
